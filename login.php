...
<html lang="en">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="probootstrap-menu">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item active"><a class="nav-link" href="cabinet.php"><i class="fa fa-user-o" aria-hidden="true"></i> Кабінет</a></li>
          </ul>
        </div>
      </div>
    </nav>
    ...
    <section class="probootstrap-cover overflow-hidden relative"  style="background-image: url('assets/images/head.jpg');" data-stellar-background-ratio="0.5"  id="section-home">
      ...
      <div class="row align-items-center">
          <div class="col-md">
            <h2 class="heading mb-2 display-4 font-light probootstrap-animate fadeInUp probootstrap-animated">Немає ще власно кабінета? Створіть!</h2>
            <p class="lead mb-5 probootstrap-animate fadeInUp probootstrap-animated">
              

            </p>
              <a href="reg.php" role="button" class="btn btn-primary p-3 mr-3 pl-5 pr-5 text-uppercase d-lg-inline d-md-inline d-sm-block d-block mb-3">Зареєструватися</a> 
            <p></p>
          </div> 
    ...
    <section class="probootstrap_section" id="section-feature-testimonial">
      ...
      <div class="row text-center mb-5 probootstrap-animate fadeInUp probootstrap-animated">
          <div class="col-md-12">
            <h2 class="display-4 border-bottom probootstrap-section-heading">Вхід</h2>
    ...
    <div class="row ">
    <form  action="Main.php" method="post" class="text-center probootstrap-form probootstrap-form-box">
          ...
          <div class="form-group">
            <input type="submit" class="btn btn-primary" id="login-btn" name="login-btn" value="Увійти">
          </div>
          <?php
