        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Редагування категорії</h1>

                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Інформація про категорію</h6>
                        </div>
                        <div class="card-body">
                            ...
                            <input type="hidden" class="form-control form-control-user" id="id" name="id"
                                    ...
                                    <input type="text" class="form-control form-control-user" id="name" name="name"
                                        placeholder="Введіть назву каткгорії" required="true" value="<?php echo $_POST["name"]; ?>">
                                </div>
                                <hr>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="photo" required="true" value="<?php echo $_POST["photo"]; ?>">
                                </div>
                                <hr>
                                
                            
                                <div class="form-group">
                                <input type="submit"  id="save-edit-category-btn" name="save-edit-category-btn" class="btn btn-primary btn-user btn-block" value="Додати категорію">
