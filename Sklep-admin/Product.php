        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Товари</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Список всіх товарів</h6>
                        </div>
                        <div class="card-body">
                                            ...
                                            <table class="table table-bordered dataTable" id="dataTable" width="100%"
                                                ...
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th style="width: 57px;">Назва товару</th>
                                                        <th style="width: 57px;">Ціна</th>
                                                        <th style="width: 57px;">Опис</th>
                                                        <th style="width: 57px;">Категорія</th>
                                                        <th style="width: 57px;">Фото</th>
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <th rowspan="1" colspan="1">Назва товару</th>
                                                        <th rowspan="1" colspan="1">Ціна</th>
                                                        <th rowspan="1" colspan="1">Опис</th>
                                                        <th rowspan="1" colspan="1">Категорія</th>
