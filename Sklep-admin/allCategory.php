        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Категорії</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Список всіх Категорій</h6>
                        </div>
                        <div class="card-body">
                                            ...
                                            <table class="table table-bordered dataTable" id="dataTable" width="100%"
                                                ...
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th style="width: 57px;">назва категорії</th>
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <th rowspan="1" colspan="1">Назва категорії</th>
