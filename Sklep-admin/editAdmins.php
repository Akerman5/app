        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Редагування адміністратора</h1>

                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Інформація про адміністратора</h6>
                        </div>
                        <div class="card-body">
                            ...
                            <input type="hidden" class="form-control form-control-user" id="id" name="id"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control form-control-user" id="email" name="email"
                                        placeholder="Введіть пошту" required="true" value="<?php echo $_POST["email"]; ?>">
                                </div>
                                <hr>
                                <div class="form-group">
                                    <label>Номер телефону</label>
                                    <input type="phone" class="form-control form-control-user" id="phone" name="phone"
                                        placeholder="Введіть номер телефону" required="true" value="<?php echo $_POST["phone"]; ?>">
                                </div>
                                <hr>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user" id="password" name="password"
                                        placeholder="Введіть пароль" required="true" value="<?php echo $_POST["password"]; ?>">
                                </div>
                                <hr>
                                <div class="form-group">
                                    <label>Статус акаунта</label>
                                    <select class="form-control" name="active" id="active"  value="<?php echo $_POST["active"]; ?>">
                                                    <option value="1" <?php  if($_POST["active"]==1)echo "selected" ; ?>>Активний</option>
                                                    <option value="0" <?php  if($_POST["active"]==0)echo "selected" ; ?>>Не активний</option>
                                                    
										</select>
                                </div>
                                <hr>
                                <div class="form-group">
                                <input type="submit"  id="save-edit-admin-btn" name="save-edit-admin-btn" class="btn btn-primary btn-user btn-block" value="Зберегти зміни">
