        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Редагування товару</h1>

                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Інформація про  товар</h6>
                        </div>
                        <div class="card-body">
                            <form action="Main.php" method="post">
                            <input type="hidden" class="form-control form-control-user" id="id" name="id" value="<?php echo $_POST["id"]; ?>">
                                <div class="form-group">
                                    <label>Назва товару</label>
                                    <input type="text" class="form-control form-control-user" id="name" name="name"
                                        placeholder="Введіть назву товару" required="true" value="<?php echo $_POST["name"]; ?>">
                                </div>
                                <hr>
                                <div class="form-group">
                                    <label>Ціна за одиницю товару</label>
                                    <input type="number" class="form-control form-control-user" id="price" name="price"
                                        placeholder="Введіть  ціну товару" required="true" value="<?php echo $_POST["price"]; ?>">
                                </div>
                                <hr>

                                <div class="form-group">
                                    <label>Опис товару</label>
                                    <textarea type="text" class="form-control form-control-user" id="info" name="info"
                                        placeholder="Введіть опис товару" required="true" value="<?php echo $_POST["info"]; ?>"><?php echo $_POST["info"]; ?></textarea>
                                </div>
                                <hr>
                                <div class="form-group">
                                    <label>Категорія товару</label>
                                    <select class="form-control" name="category" id="category"  value="Оберіть категорію">
                                                    <?php loadCategoryInEditProduct($_POST["category"]) ?>
                                ...
                                <hr>
                                <div class="form-group">
                                <input type="submit"  id="save-edit-product-btn" name="save-edit-product-btn" class="btn btn-primary btn-user btn-block" value="Зберегти зміни">
