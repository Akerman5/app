        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Додавання нової категорії</h1>

                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Інформація про нову категорію</h6>
                        </div>
                        <div class="card-body">
                            <form action="Main.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user" id="name" name="name"
                                        placeholder="Введіть назву каткгорії" required="true" value="">
                                </div>
                                <hr>
                                ...
                                <div class="form-group">
                                <input type="submit"  id="add-new-category-btn" name="add-new-category-btn" class="btn btn-primary btn-user btn-block" value="Додати категорію">
