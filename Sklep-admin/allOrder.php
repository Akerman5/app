        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Замовлення</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Список всіх замовлень</h6>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <table class="table table-bordered dataTable" id="dataTable" width="100%"
                                                ...
                                                <thead>
                                                    <tr role="row">
                                                        <th style="width: 57px;">Дії</th>
                                                        <th style="width: 57px;">Адрес</th>
                                                        <th style="width: 57px;">Повідомлення</th>
                                                        <th style="width: 57px;">ПІБ</th>
                                                        <th style="width: 57px;">Статус замовлення</th>
                                                        <th style="width: 57px;">Сума</th>
                                                        <th style="width: 57px;">Замовлення</th>
                                                        <th style="width: 57px;">Пошта</th>
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        <th rowspan="1" colspan="1">Дії</th>
                                                        <th rowspan="1" colspan="1">Адрес</th>
                                                        <th rowspan="1" colspan="1">Повідомлення</th>
                                                        <th rowspan="1" colspan="1">ПІБ</th>
                                                        <th rowspan="1" colspan="1">Статус замовлення</th>
                                                        <th rowspan="1" colspan="1">Сума</th>
                                                        <th rowspan="1" colspan="1">Замовлення</th>
                                                        <th rowspan="1" colspan="1">Пошта</th>
                                                    </tr>
                                                </tfoot>
                                                <tbody>
