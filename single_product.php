        ...
        <div class="col-md-12">
          ...
          <input  type="hidden" name="id" value="<?php   echo $_POST["id"] ?>">
            <div class="product-breadcroumb">
              ...
              <a href="catalog.php">Каталог товарів /</a>
              <a href="">
                <?php echo $_POST["name"] ?>
              </a>
            </div>
            ...
            <div class="row">
              <div class="col-sm-6">
                <img src="assets/images/img_4.jpg" class="img-fluid rounded">

              </div>
              <div class=" media-body">
                <h2 class=""><?php echo $_POST["name"] ?></h2>

                <h4>Ціна : </h4>
                <ins>₴ <?php echo $_POST["price"] ?></ins> <del></del>

                <h4>Опис товару</h4>
                <p><?php echo str_replace("\r\n","</br>",$_POST["info"]) ?></p>
                <label>Кількість</label>
                <input type="count" size="4" class="input-text qty text" title="Qty" value="1" id="count" name="count" min="1" step="1">
                <br>
                <button class="btn btn-primary" id="add-to-cart-btn" name="add-to-cart-btn" type="submit">Додати в корзину</button>
              </div>
