    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="probootstrap-menu">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"><a class="nav-link" href="city-guides.html">Каталог товарів</a></li>
          <li class="nav-item"><a class="nav-link" href="services.html">Виробники</a></li>
          <li class="nav-item"><a class="nav-link" href="travel.html">Акції</a></li>
      ...
      <div class="row align-items-center">
        <div class="col-md">
          ...
          <a href="login.php" role="button"
            class="btn btn-primary p-3 mr-3 pl-5 pr-5 text-uppercase d-lg-inline d-md-inline d-sm-block d-block mb-3">Перейти
            до .. треба ше придумати куда</a>
          <p></p>
        </div>
  ...
  <section class="probootstrap_section" id="section-feature-testimonial">
    <div class="container">
      <div class="row text-center mb-5 probootstrap-animate fadeInUp probootstrap-animated">
        <div class="col-md-12">
          <h2 class="display-4 border-bottom probootstrap-section-heading">Мій Кабінет</h2>
      ...
      <div class="row ">
        <div class="text-center probootstrap-form probootstrap-form-box">
          ...
          <div class="form-group">
            ...
            <a href="cabinet.php" class="btn btn-primary btn-lg btn-block" id="history-btn" name="history-btn" value="">
              <i class="fa fa-history" aria-hidden="true"> Історія замовелень</i>
            </a>
          </div>
          <div class="form-group">
            <a href="cabinet.php" class="btn btn-primary btn-lg btn-block" id="dateCostomer-btn" name="dateCostomer-btn" value="">
            <i class="fa fa-address-book-o" aria-hidden="true"> Контактні даннні</i>
            </a>
          </div>
          <div class="form-group">
            <a href="cabinet.php" class="btn btn-danger btn-lg btn-block" id="logout-btn" name="logout-btn" value="">
            <i class="fa fa-sign-out" aria-hidden="true"> Вийти з аккаунта</i>
            </a>
          </div>
