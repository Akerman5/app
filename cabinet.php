      ...
      <div class="row ">
        <div class="text-center probootstrap-form probootstrap-form-box">
          ...
          <div class="form-group">
            ...
            <a href="orderHistory.php" class="btn btn-primary btn-lg btn-block" id="history-btn" name="history-btn" value="">
              <i class="fa fa-history" aria-hidden="true"> Історія замовелень</i>
            </a>
          </div>
          <div class="form-group">
            
            <a href="cart.php" class="btn btn-primary btn-lg btn-block" id="cart-btn" name="cart-btn" value="">
              <i class="fa fa-shopping-cart" aria-hidden="true"> Корзина</i>
            </a>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <a href="logout.php" class="btn btn-danger btn-lg btn-block" id="logout-btn" name="logout-btn" value="">
